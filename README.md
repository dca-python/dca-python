...
I'm an economist by training, with a solid background in mathematical modeling and applied statistics using R. My fascination with machine learning led me to complete Le Wagon's intensive *Data Science & AI* bootcamp, where I spent 660 hours immersed in data using Python, SQL, and a variety of MLOps tools.
